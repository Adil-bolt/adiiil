                ...
                {isLunchBreak ? (
                  <div className="p-2 rounded bg-gray-100 text-gray-800">
                    <div className="flex items-center justify-center">
                      <span className="font-medium">PAUSE_DEJEUNER</span>
                    </div>
                  </div>
                ) : (
                  <>
        ...
        <React.Fragment key={time}>
          ...
          {days.map(day => {
            ...
            return (
              <div
                key={day.toString()}
                className={`border border-gray-100 p-1 min-h-[40px] ${
                  isPauseSlot ? 'bg-stripes-gray' : ''
                }`}
                onClick={() => !isPauseSlot && handleTimeSlotClick(day, time)}
              >
                {isLunchBreak ? (
                  <div className="p-1 rounded bg-gray-100 text-gray-800">
                    <div className="flex items-center justify-center">
                      <span className="text-xs font-medium">PAUSE_DEJEUNER</span>
                    </div>
                  </div>
                ) : (
                  <>
